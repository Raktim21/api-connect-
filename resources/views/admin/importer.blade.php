                        ...
                        <div class="btn-group">
                            ...
                            <form action="{{ route('admin.importer.index') }}" method="GET">
                                <div class="btn-group">
                                    ...
                                    <input class="form-control" id="search" type="text" name="search" placeholder="Search" style="boarder:1px solid black" value="{{ request('search') }}">
...
<div id="importSidebar" class="sidebar-import">
    ...
    <div class="mb-3">
        ...
        <div class="form-text">Please upload an Excel file with Importer IDs in the first column</div>
            ...
            reader.onload = async (e) => {
                try {
                    ...
                    for (let i = 0; i < importerIDs.length; i += 10) {
                        ...
                        const res = await fetch("{{ route('admin.importer.api') }}", {
                            method: 'POST',
                            headers: {
